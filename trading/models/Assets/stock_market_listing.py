...
class Asset:
    ...
    def visualize_ticker(self):
        ...
        table.add_row("Last Price", f"[bold green]{self.last_price:.2f}[/bold green]")
        table.add_row("Bid Price", f"[bold red]{self.bid_price:.2f}[/bold red]")
        table.add_row("Ask Price", f"[bold blue]{self.ask_price:.2f}[/bold blue]")
