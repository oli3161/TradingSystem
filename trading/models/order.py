...
class Order:
    ...
    def __init__(
        ...
        self.buy_order = (
            buy_order  # Can only be True or False, if False then it is a sell order
        )
    ...
    def complete_order(self) -> NoReturn:
    ...
    def decrease_quantity_traded(self, quantity: int) -> NoReturn:
        self.remaining_quantity -= quantity
    ...
    def __str__(self):
        return (
            f"Order(ticker={self.ticker}, price={self.price}, quantity={self.initial_quantity}, "
