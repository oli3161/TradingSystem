...
class PortfolioStock:
    ...
    def __init__(
        ...
        shares_owned: int = 0,
        average_purchase_price: float = 0,
        ...
        if self.shares_owned and self.average_purchase_price and self.market_price:
            ...
            self.unrealized_gain_loss = (
                market_price - average_purchase_price
            ) * shares_owned
    ...
    def add_shares(self, quantity: int, price: float) -> NoReturn:
        ...
        self.unrealized_gain_loss = (
            self.market_price - self.average_purchase_price
        ) * self.shares_owned
    ...
    def __str__(self):
        return (
            f"Ticker: {self.ticker_symbol}, Shares: {self.shares_owned}, "
